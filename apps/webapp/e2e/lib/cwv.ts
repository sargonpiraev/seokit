...
export async function waitForInpSample(page: Page, timeoutMs = 15_000): Promise<CwvMetrics> {
  await page.waitForFunction(() => window.__cwv != null && window.__cwv.inp != null, undefined, {
    timeout: timeoutMs,
  })
