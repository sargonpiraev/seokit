...
import { getPokemon, listDemoGenerations, listDemoPokemon, listDemoTypes } from '@/lib/pokeapi'
...
export default async function HomePage({ params }: HomePageProps) {
  ...
  const featured = catalog.filter((entry) => ['pikachu', 'eevee', 'charizard'].includes(entry.slug))
        ...
        <div className="grid items-center gap-8 p-6 md:grid-cols-[1.1fr_0.9fr] md:p-10">
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <h1 className="text-4xl font-semibold tracking-tight md:text-5xl">{hero.name}</h1>
